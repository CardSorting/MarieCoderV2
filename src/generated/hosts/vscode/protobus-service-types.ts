...
export type UiServiceHandlers = {
     ...
     subscribeToFocusChatInput:(controller: Controller, request: proto.cline.EmptyRequest, responseStream: StreamingResponseHandler<proto.cline.Empty>, requestId?: string) => Promise<void>
